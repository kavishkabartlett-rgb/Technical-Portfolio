...
public class DNABenchmark {
	...
	public static void main(String[] args)
		...
		/** Comment out spliceeBenchmark() and sourceBenchmark() if using the below code
		----------------Cut and Splice------------
		IDnaStrand dna = new LinkStrand(mySource);
		System.out.println("Original DNA strand: " + dna);
		IDnaStrand spliced = dna.cutAndSplice("[DNA sequence to find]", "[What to replace sequence with]");
		System.out.println("Spliced DNA: " + spliced);

		----------------Append---------------------
    	IDnaStrand dna = new LinkStrand(mySource);
    	System.out.println("Original DNA: " + dna);
    	dna.append("[Sequence to Add]");
    	System.out.println("After Appending: " + dna);

		----------------Reverse--------------------
    	IDnaStrand dna = new LinkStrand(mySource);
    	System.out.println("Original DNA: " + dna);
    	IDnaStrand reversed = dna.reverse();
    	System.out.println("Reversed DNA: " + reversed);
		*/
