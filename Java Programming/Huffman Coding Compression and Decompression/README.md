...
- <big>**Can Compress Variety of Media**</big> Can compress .txt, .hf, .tiff (images), and .jpg files as long as the files are in their raw format 
...
- Extend file support to further compress already compressed media
