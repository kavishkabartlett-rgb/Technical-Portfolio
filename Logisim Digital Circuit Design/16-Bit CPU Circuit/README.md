...
*Outputs folder has pictures of each circuit file, every black box with a name at the bottom is a representation of another file. For example, in main, the box named
