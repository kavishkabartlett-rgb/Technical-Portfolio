...
am investigating using parallelism, physic-informed neural networks, and deep learning surrogate models to dramatically accelerate fluid flow modeling. As my research is still ongoing, any files found in the research directory may be unpolished and subject to change. All other directories contain fully completed projects, as well as a detailed README file containing the following sections: 
