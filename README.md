...
am investigating using parallelism, physic-informed neural networks, and deep learning surrogate models to dramatically accelerate fluid flow modeling. Every directory includes a detailed README file, which contains the following sections: 
