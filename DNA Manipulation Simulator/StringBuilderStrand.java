/**
 * Implements the StringBuilder solution to the DNA problem
 * Uses StringBuilder for efficient appends without large memory overhead
 * Contains all strand manipulation operations (reverse, cut/splice, etc.)
 * 
 * @author ola
