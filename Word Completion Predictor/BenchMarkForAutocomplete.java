 ...
 * Benchmarks the performance of different autocomplete implementations
 * Outputs a table with runtime and memory usage for each implementation
 * Runs with automatic settings and files in the data folder - to run, just compile and run
 */
