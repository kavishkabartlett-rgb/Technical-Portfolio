/* --------------------------------------------------------------------------------------------------
 Contains unit tests for Term class. Creates test cases to verify that Term objects
 are properly compared and sorted. Checks compareTo, byReverseWeightOrder, and byPrefixOrder methods
-----------------------------------------------------------------------------------------------------*/
